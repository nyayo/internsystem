...
SECRET_KEY = config("SECRET_KEY", default="django-insecure-5t9=a0q7^c-syh#3ie_vci#o9xidk$3w*7#*_*i3xus-)p(g%t")
...
DATABASES = {
    "default": {
        ...
        'NAME': config("DB_NAME", default="interndb"),
...
EMAIL_HOST_USER = config("EMAIL_HOST_USER", default="nyayoi799@gmail.com")
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD", default="bxof qzpc cajz kewc")
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="nyayoi799@gmail.com")

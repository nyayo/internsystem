...
export default function PlacementApplicationModal({ placement, onClose, onSubmit }) {
  ...
  // Initialize form with existing placement, draft, or empty values
        ...
        <div className="modal-header">
          <div>
            ...
            <p className="modal-subtitle">
              {isViewOnly ? 'View your placement details' : 'Submit your internship placement details'}
            </p>
          </div>
          ...
          <section className="form-section">
            ...
            <div className="form-grid">
              <div className="form-group full-width">
                ...
                />
                {errors.organisationName && <span className="error-text">{errors.organisationName}</span>}
              </div>
              ...
              <div className="form-group">
                ...
                {errors.organisationType && <span className="error-text">{errors.organisationType}</span>}
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => handleChange('organisationDistrict', e.target.value)}
                  placeholder="e.g., Kampala"
                  disabled={isViewOnly}
                  className={errors.organisationDistrict ? 'error' : ''}
                />
                {errors.organisationDistrict && <span className="error-text">{errors.organisationDistrict}</span>}
              </div>
          ...
          <section className="form-section">
            ...
            <div className="form-grid">
              <div className="form-group">
                ...
                />
                {errors.wpSupervisorName && <span className="error-text">{errors.wpSupervisorName}</span>}
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => handleChange('wpSupervisorTitle', e.target.value)}
              ...
              <div className="form-group">
                ...
                />
                {errors.wpSupervisorEmail && <span className="error-text">{errors.wpSupervisorEmail}</span>}
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => handleChange('wpSupervisorPhone', e.target.value)}
                  placeholder="e.g., +256 700 123456"
                  disabled={isViewOnly}
                  className={errors.wpSupervisorPhone ? 'error' : ''}
                />
                {errors.wpSupervisorPhone && <span className="error-text">{errors.wpSupervisorPhone}</span>}
              </div>
            </div>
          </section>
              ...
              <div className="form-group">
                ...
                <div className="file-upload">
                  ...
                  <label htmlFor="requestLetter" className="file-label">
                    ...
                    <span>{formData.requestLetter?.name || 'Choose file'}</span>
                  </label>
                </div>
              </div>
              ...
              <div className="form-group">
                ...
                <div className="file-upload">
                  ...
                  <label htmlFor="acceptanceLetter" className="file-label">
                    <span className="material-icons-sharp">upload_file</span>
                    <span>{formData.acceptanceLetter?.name || 'Choose file'}</span>
                  </label>
                </div>
              </div>
            </div>
